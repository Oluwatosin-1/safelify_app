...
Future<Clinic> getSelectedClinicAPI({int? page, required String clinicId, bool isForLogin = false}) async {
  ClinicListModel res =
      ClinicListModel.fromJson(await (handleResponse(await buildHttpResponse('${ApiEndPoints.clinicApiEndPoint}/${EndPointKeys.getListEndPointKey}?page=${page != null ? page : ''}'))));
