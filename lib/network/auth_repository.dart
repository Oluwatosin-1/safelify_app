...
import 'package:safelify/utils/constants/user_detail_keys.dart';
...
Future<void> logout({bool isTokenExpired = false}) async {
  ...
  push(const SignInScreen(), isNewTask: true, pageRouteAnimation: signInAnimation, duration: const Duration(milliseconds: 600));
}
