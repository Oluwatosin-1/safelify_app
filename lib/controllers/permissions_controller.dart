...
//             Permissions(currentPlan: response['data'][0]['plan_title']);
//     } catch (e) {
...
//     log("Requesting canNotifyContacts for :: ${requestType}");
//     if (this._workPlaceEmergency(requestType) &&
//         permissionManager.value!.planType != PlanType.Business) return false;
...
//     // Workplace emergency is only for business
//     log("Requesting canRequestForImmediateHelp for :: ${requestType}");
//     if (this._workPlaceEmergency(requestType) &&
//         permissionManager.value!.planType != PlanType.Business) return false;
...
//     if (type == 'Workplace Accident' ||
//         type == 'Medical Emergencies' ||
//         type == 'Cyber Emergencies' ||
//         type == 'Physical Attack' ||
//         type == 'Legal Emergencies') {
//       return true;
//     }
