...
List<LanguageDataModel> languageList() {
  return [
    ...
    LanguageDataModel(
        id: 5,
        name: locale.lblChinese,
        languageCode: 'zh',
        fullLanguageCode: 'zh-ZH',
        flag: flagsIcCh),
    LanguageDataModel(
        id: 6,
        name: locale.lblRussian,
        languageCode: 'ru',
        fullLanguageCode: 'ru-RU',
        flag: flagsIcRU),
    LanguageDataModel(
        id: 7,
        name: locale.lblSpaines,
        languageCode: 'se',
        fullLanguageCode: 'se-SE',
        flag: flagsIcSP),
    LanguageDataModel(
        id: 8,
        name: locale.lblPortugusse,
        languageCode: 'pt',
        fullLanguageCode: 'pt-PT',
        flag: flagsIcPT),
    LanguageDataModel(
        id: 9,
        name: locale.lblJapanes,
        languageCode: 'jp',
        fullLanguageCode: 'jp-JP',
        flag: flagsIcJP),
  ];
}
...
const String WHATSAPP_NUMBER = '+2348059148033'; // Replace with actual support number
const String WHATSAPP_MESSAGE = 'Hello, I need assistance with my appointment.';
