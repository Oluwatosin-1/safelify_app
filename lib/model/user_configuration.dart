class UserConfiguration {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['isKiviCareGooglemeetActive'] = isKiviCareGooglemeetActive;
    data['isKiviCareProOnName'] = isKiviCareProOnName;
    data['isTeleMedActive'] = isTeleMedActive;
    data['is_enable_doctor_gcal'] = is_enable_doctor_gcal;
    data['is_enable_google_cal'] = is_enable_google_cal;
    data['is_patient_enable'] = is_patient_enable;
    data['is_uploadfile_appointment'] = is_uploadfile_appointment;
    data['message'] = message;
    data['telemed_type'] = telemed_type;
    data['role'] = role;
    data['status'] = status;
    data['user_id'] = user_id;
    if (restrict_appointment != null) {
      data['restrict_appointment'] = restrict_appointment!.toJson();
    }
    return data;
  }
}
