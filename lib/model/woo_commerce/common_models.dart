...
List<FilterModel> getOrderStatus() {
  ...
  list.add(FilterModel(value: OrderStatus.processing, title: locale.lblProcessing, statusColor: processingStatusColor));
  ...
  list.add(FilterModel(value: OrderStatus.failed, title: locale.lblFailed, statusColor: failedStatusColor));
  list.add(FilterModel(value: OrderStatus.trash, title: locale.lblTrash, statusColor: trashStatusColor));
