...
import 'package:safelify/model/encounter_module.dart';
import 'package:safelify/model/module_config_model.dart';
import 'package:safelify/model/prescription_module.dart';
import 'package:safelify/model/qualification_model.dart';
import 'package:safelify/model/rating_model.dart';
import 'package:safelify/model/restrict_appointment_model.dart';
import 'package:safelify/model/service_model.dart';
import 'package:safelify/model/speciality_model.dart';
...
class UserModel {
  ...
  factory UserModel.fromJson(Map<String, dynamic> json) {
    return UserModel(
      ...
      lastName:
          json['last_name'] ?? json['display_name'].toString().split(' ').last,
      ...
      drugAllergies: json['drug_allergies'],
  ...
  Map<String, dynamic> toJson() {
    ...
    json['drug_allergies'] = drugAllergies;
