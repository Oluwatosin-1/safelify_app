...
import 'package:safelify/telelegal/model/report_model.dart';
import 'package:safelify/telelegal/screens/doctor/screens/add_prescription_screen.dart';
import 'package:safelify/telelegal/screens/encounter/component/encounter_functions.dart';
import 'package:safelify/telelegal/screens/encounter/component/encounter_prescription_component.dart';
import 'package:safelify/telelegal/screens/encounter/component/encounter_type_%20component.dart';
import 'package:safelify/telelegal/screens/encounter/component/report_component.dart';
    ...
    return AnimatedWrap(
      ...
      itemBuilder: (context, index) {
        ...
        return EncounterTypeComponent(
          data: encounterData,
          isDeleteOn: widget.encounterData.status == '1' &&
              isVisible(SharedPreferenceKey.kiviCareMedicalRecordsDeleteKey),
          onTap: () {
            showConfirmDialogCustom(
              context,
