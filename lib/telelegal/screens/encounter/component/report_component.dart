...
class ReportComponent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          if (reportData.uploadReport != null &&
            ...
            Image(
                image: const AssetImage(ic_invalidURL),
          ...
          Row(
            children: [
              ...
              if (showDelete &&
                  isVisible(SharedPreferenceKey.kiviCarePatientReportDeleteKey))
                IconButton(
                  visualDensity: VisualDensity.compact,
                  padding: EdgeInsets.zero,
                  icon: const Icon(Icons.delete, size: 20, color: iconColor),
      ...
      if (isVisible(SharedPreferenceKey.kiviCarePatientReportEditKey) &&
          !isPatient())
        AddReportScreen(
