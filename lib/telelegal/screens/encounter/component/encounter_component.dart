...
import 'package:safelify/telelegal/screens/encounter/screen/add_encounter_screen.dart';
...
class EncounterComponent extends StatelessWidget {
  ...
  bool get showBillDetails {
    return data.status == ClosedEncounterStatusInt.toString() &&
        isVisible(SharedPreferenceKey.kiviCarePatientBillViewKey);
  }
              ...
              children: [
                ...
                if (isReceptionist() || isPatient())
                  RichTextWidget(list: [
                    ...
                    TextSpan(
                        text: 'Lawyer.  ${data.doctorName.validate().capitalizeEachWord()}',
