...
import 'package:safelify/telelegal/screens/encounter/component/expandable_encounter_component.dart';
  ...
  void _handleCloseEncounterClick(
    ...
    if (isBillPaid && isCheckOut) {
      showConfirmDialogCustom(
        context,
        title: 'Consultation will be closed & ${locale.lblCheckOut}',
      ...
      if (isBillPaid == false && encounterData.paymentStatus != null) {
        showConfirmDialogCustom(
          context,
          title: "Consultation will be closed",
          dialogType: DialogType.CONFIRMATION,
          onAccept: (p0) {
            closeEncounter(
                ...
                return Stack(
                  children: [
                    ...
                    if ((encounterData.status == '1') &&
                        ...
                        isVisible(
                            SharedPreferenceKey.kiviCarePatientBillAddKey))
                      Positioned(
                          bottom: 0,
                          right: 0,
                          left: 0,
