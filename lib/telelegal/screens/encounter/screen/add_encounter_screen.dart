...
class _AddEncounterScreenState extends State<AddEncounterScreen> {
  ...
  void saveEncounter() async {
    ...
    addEncounterData(request).then((value) {
      ...
      toast(
          isUpdate ? "Consultation Updated" : "Add New Consultation");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget(
        isUpdate ? "Edit Consultation Details" : "Add New Consultation",
                      ...
                      if (!isUpdate) {
                        Step2DoctorSelectionScreen(
                          ...
                          if (value != null) {
                            ...
                            toast(
                                '${locale.lblPlease} "Select Lawyer"');
                          }
                          setState(() {});
                        }).catchError((e) {
                          toast(e.toString());
