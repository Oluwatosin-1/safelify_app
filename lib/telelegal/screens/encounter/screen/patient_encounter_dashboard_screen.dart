...
import 'package:safelify/telelegal/model/prescription_model.dart';
...
import 'package:safelify/telelegal/screens/patient/components/patient_report_component.dart';
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text("Firm Name", style: secondaryTextStyle(size: 12)),
                Text(data.clinicName.validate(), style: boldTextStyle()),
                8.height,
                Text("Lawyer Name", style: secondaryTextStyle(size: 12)),
      ...
      child: Column(
        ...
        children: [
          ...
          if (data.prescription != null &&
              isVisible(SharedPreferenceKey.kiviCarePrescriptionListKey))
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              mainAxisSize: MainAxisSize.min,
              children: [
                Text("Recommendation", style: boldTextStyle()),
                12.height,
                if (data.prescription.validate().isNotEmpty)
                  ...
                  Text("No recommendation found".capitalizeEachWord(),
                      style: secondaryTextStyle()),
              ],
            ),
          if (isVisible(SharedPreferenceKey.kiviCarePatientReportKey))
            32.height,
          if (isVisible(SharedPreferenceKey.kiviCarePatientReportKey))
            Text("Case File Report", style: boldTextStyle()),
          16.height,
          if (isVisible(SharedPreferenceKey.kiviCarePatientReportKey))
