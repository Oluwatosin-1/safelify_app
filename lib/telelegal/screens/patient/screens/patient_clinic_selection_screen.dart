...
import 'package:safelify/screens/patient/components/clinic_component.dart';
import 'package:safelify/telelegal/screens/shimmer/screen/switch_clinic_shimmer_screen.dart';
...
class _PatientClinicSelectionScreenState
  ...
  Future<void> switchFavouriteClinic(int selectedClinicId, int newIndex) async {
    ...
    showConfirmDialogCustom(
      ...
      title: "Do you want to switch your Firm?",
      onCancel: (p0) {
