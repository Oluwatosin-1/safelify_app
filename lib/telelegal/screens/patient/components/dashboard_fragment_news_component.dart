...
import 'package:safelify/telelegal/screens/patient/components/news_dashboard_widget.dart';
...
class DashBoardFragmentNewsComponent extends StatelessWidget {
  ...
  const DashBoardFragmentNewsComponent({super.key, required this.newsList});
