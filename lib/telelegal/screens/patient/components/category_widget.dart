...
import 'package:safelify/telelegal/components/cached_image_widget../../../model/service_model.dart';
      ...
      decoration: data.image.validate().isNotEmpty
          ? boxDecorationDefault(
              ...
              image: DecorationImage(
                fit: BoxFit.cover,
                colorFilter:
                    const ColorFilter.mode(Colors.black54, BlendMode.multiply),
                image: NetworkImage(
                  data.image.validate(),
                ),
              ),
      ...
      child: Column(
        ...
        children: [
          ...
          if (data.doctorList.validate().length > 0)
            Text(
              '${data.doctorList.validate().length} ${(data.doctorList.validate().length > 1) ? "Lawyer Available" : "Lawyer Available"}',
