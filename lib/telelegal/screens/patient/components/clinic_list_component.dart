...
import 'package:safelify/telelegal/screens/shimmer/screen/service_data_shimmer.dart';
...
class AvailableClinicListComponent extends StatefulWidget {
  ...
  AvailableClinicListComponent(
      {required this.doctorData, required this.serviceName});

  @override
  State<AvailableClinicListComponent> createState() =>
      _AvailableClinicListComponentState();
}

class _AvailableClinicListComponentState
    extends State<AvailableClinicListComponent> {
  ...
  void init() async {
    ...
    getClinicWiseDoctorsServiceData(
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
                          ...
                          children: [
                            ...
                            Divider(color: viewLineColor, height: 2).visible(
                                appStore.isDarkModeOn &&
                                    serviceData.image.validate().isEmpty),
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [
                                Marquee(
                                    ...
                                    children: [
                                      RichTextWidget(
                                        list: [
                                          TextSpan(
                                              text:
                                                  '${appStore.currencyPrefix.validate()} ',
                                              style:
                                                  primaryTextStyle(size: 14)),
                                          TextSpan(
                                            text:
                                                '${serviceData.charges}${appStore.currencyPostfix}',
                                ...
                                if (serviceData.isTelemed.validate())
                                  FittedBox(
                                    child: Row(
                                      ...
                                      children: [
                                        ic_telemed.iconImage(
                                            color: appSecondaryColor, size: 18),
                                        4.width,
                                        Text(
          ...
          Observer(
            builder: (context) {
              return ServiceDataShimmer()
                  .visible(appStore.isLoading && dataList.isEmpty && page == 1);
            },
          ),
          Observer(
            builder: (context) {
