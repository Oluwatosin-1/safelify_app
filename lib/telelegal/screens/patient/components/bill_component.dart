...
import 'package:safelify/telelegal/model/bill_list_model.dart';
import 'package:safelify/telelegal/model/encounter_model.dart';
import 'package:safelify/telelegal/screens/doctor/screens/bill_details_screen.dart';
import 'package:safelify/telelegal/screens/encounter/screen/encounter_dashboard_screen.dart';
import 'package:safelify/telelegal/screens/doctor/screens/generate_bill_screen.dart';
...
class BillComponent extends StatelessWidget {
  ...
  bool get showEdit {
    return (isReceptionist() || isDoctor()) &&
        !billData.paymentStatus.validate().getBoolInt() &&
        isVisible(SharedPreferenceKey.kiviCarePatientBillEditKey);
  }
        ...
        endActionPane: ActionPane(
          ...
          children: [
            ...
            if (showBillDetails)
              SlidableAction(
                ...
                borderRadius: BorderRadius.only(
                  topLeft:
                      showEdit ? Radius.zero : Radius.circular(defaultRadius),
                  bottomLeft:
                      showEdit ? Radius.zero : Radius.circular(defaultRadius),
                  topRight: showEncounterDashboard
                      ? Radius.zero
                      : Radius.circular(defaultRadius),
                  bottomRight: showEncounterDashboard
                      ? Radius.zero
                      : Radius.circular(defaultRadius),
                ),
            ...
            if (showEncounterDashboard)
              SlidableAction(
                borderRadius: BorderRadius.only(
                  topLeft: showEdit || showBillDetails
                      ? Radius.zero
                      : Radius.circular(defaultRadius),
                  bottomLeft: showEdit || showBillDetails
                      ? Radius.zero
                      : Radius.circular(defaultRadius),
                ...
                onPressed: (context) {
                  if (isPatient()) {
                    ...
                    EncounterDashboardScreen(
                            encounterId:
                                billData.encounterId.validate().toString())
                        .launch(context,
                            pageRouteAnimation: pageAnimation,
                            duration: pageAnimationDuration);
                  }
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      RoleWidget(
                        ...
                        isShowReceptionist: true,
                        child: Text(
                            billData.doctorName.validate().capitalizeEachWord().prefixText(value: 'Lawyer. '),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          if (billData.totalTax != null)
                            PriceWidget(
                                    price: (billData.totalAmount.validate() -
                                            billData.discount.validate() -
                                            billData.actualAmount.validate())
                                        .abs()
                                        .toStringAsFixed(2),
                                    textSize: 14)
                                .expand(),
                          PriceWidget(
                                  price: billData.actualAmount
                                      .validate()
                                      .toStringAsFixed(2),
                                  textSize: 14)
                              .expand(),
