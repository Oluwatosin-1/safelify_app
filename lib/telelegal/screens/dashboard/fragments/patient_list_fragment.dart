...
import 'package:safelify/telelegal/screens/doctor/components/patient_list_component.dart';
import 'package:safelify/telelegal/screens/receptionist/screens/patient/add_patient_screen.dart';
import 'package:safelify/telelegal/screens/shimmer/screen/patient_fragment_shimmer.dart';
...
class _PatientListFragmentBodyComponentState
  ...
  @override
  void initState() {
    String res = isReceptionist()
        ? getStringAsync(SharedPreferenceKey.cachedReceptionistPatientListKey)
        : getStringAsync(SharedPreferenceKey.cachedDoctorPatientListKey);
    if (res.isNotEmpty) {
      cachedPatientList =
          (jsonDecode(res) as List).map((e) => UserModel.fromJson(e)).toList();
    }
    super.initState();
  ...
  Future<void> init({bool showLoader = true}) async {
    ...
    future = getPatientListAPI(
      ...
      clinicId:
          isReceptionist() ? userStore.userClinicId.validate().toInt() : null,
