...
import 'package:safelify/telelegal/screens/dashboard/fragments/doctor_list_fragment.dart';
import 'package:safelify/telelegal/screens/dashboard/fragments/patient_list_fragment.dart';
import 'package:safelify/telelegal/fragments/setting_fragment.dart';
import 'package:safelify/telelegal/screens/receptionist/fragments/r_appointment_fragment.dart';
  ...
  Widget build(BuildContext context) {
    return DoublePressBackWidget(
      child: Observer(builder: (context) {
        if (receptionistAppStore.bottomNavIndex >= getScreens().length)
          receptionistAppStore.setBottomNavIndex(getScreens().length - 1);
