...
import 'package:safelify/telelegal/components/body_widget.dart';
...
import 'package:safelify/telelegal/screens/doctor/components/appointment_fragment_appointment_component.dart';
import 'package:safelify/telelegal/screens/shimmer/components/appointment_shimmer_component.dart';
...
import 'package:safelify/telelegal/utils/constants/sharedpreference_constants.dart';
...
class _AppointmentFragmentState extends State<AppointmentFragment> {
  ...
  void initState() {
    ...
    if (res.isNotEmpty) {
      cachedDoctorAppointment = (jsonDecode(res) as List)
          .map((e) => UpcomingAppointmentModel.fromJson(e))
          .toList();
    }
