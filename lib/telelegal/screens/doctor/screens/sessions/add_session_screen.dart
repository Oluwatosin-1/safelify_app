...
import 'package:safelify/telelegal/model/doctor_session_model.dart';
import 'package:safelify/telelegal/model/user_model.dart';
import 'package:safelify/telelegal/model/week_days_model.dart';
import 'package:safelify/telelegal/network/doctor_sessions_repository.dart';
import 'package:safelify/telelegal/screens/appointment/screen/step1_clinic_selection_screen.dart';
  ...
  Future<void> init() async {
    ...
    if (isUpdate) {
      ...
      selectedDoctorCon.text =
          'Lawyer.  ' + widget.sessionData!.doctors.validate();
