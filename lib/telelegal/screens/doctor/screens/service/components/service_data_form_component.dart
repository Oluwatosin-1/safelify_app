...
class ServiceDataFormComponent extends StatefulWidget {
  ...
  @override
  _ServiceDataFormComponentState createState() =>
      _ServiceDataFormComponentState();
}
...
class _ServiceDataFormComponentState extends State<ServiceDataFormComponent> {
  ...
  void init() async {
    ...
    if (isUpdate) {
      ...
      if (widget.serviceData!.status != null)
        isActive = widget.serviceData!.status.getBoolInt();
      if (widget.serviceData!.multiple != null)
      ...
      children: [
        ...
        DropdownButtonHideUnderline(
          child: DropdownButtonFormField<DurationModel>(
            ...
            items:
                durationList.map<DropdownMenuItem<DurationModel>>((duration) {
              return DropdownMenuItem<DurationModel>(
                value: duration,
                child:
                    Text(duration.label.validate(), style: primaryTextStyle()),
              );
            }).toList(),
          ),
        ),
