          ...
          return Stack(
            ...
            children: [
              AnimatedScrollView(
                ...
                children: [
                  Text("Firm Details".toUpperCase(),
                      style: boldTextStyle(size: 16)),
                  const Divider(color: viewLineColor, height: 24),
                  clinicDetails(patientBillData: snap.data!),
                  const Divider(color: viewLineColor, height: 24),
                  16.height,
                  Text("Client Details".toUpperCase(),
                      style: boldTextStyle(size: 16)),
                  const Divider(color: viewLineColor, height: 24),
                  if (snap.data != null)
        ...
        Row(
          children: [
            Column(
              ...
              children: [
                ...
                RichTextWidget(
                  list: [
                    TextSpan(
                        text: locale.lblInvoiceId + ': ',
                        style: boldTextStyle(size: 12)),
                    TextSpan(
                        text: '#${patientBillData.id.validate()} ',
                        style: primaryTextStyle(size: 12)),
                  ],
                ),
                4.height,
            ...
            Column(
              ...
              children: [
                Text(patientBillData.clinic!.city.validate(),
                ...
                Row(
                  ...
                  children: [
                    ...
                    StatusWidget(
                        status:
                            patientBillData.paymentStatus == 'paid' ? '1' : '0',
    ...
    return Column(
      ...
      children: [
        RichTextWidget(
          list: [
            TextSpan(
                ...
                style: boldTextStyle(size: 12)),
            TextSpan(
                text: patientBillData.patient!.displayName.validate(),
                style: primaryTextStyle(size: 12)),
          ],
        ),
        6.height,
        RichTextWidget(
          list: [
            TextSpan(
                text: locale.lblGender2 + ': ', style: boldTextStyle(size: 12)),
            TextSpan(
                text:
                    patientBillData.patient!.gender.validate().capitalizeFirstLetter(),
                style: primaryTextStyle(size: 12)),
          ],
        ),
        6.height,
        RichTextWidget(
          list: [
            TextSpan(
                text: locale.lblDOB + ': ', style: boldTextStyle(size: 12)),
            TextSpan(
                text: '${patientBillData.patient?.dob.validate()}',
                style: primaryTextStyle(size: 12)),
          ],
        ),
      ],
  ...
  Widget servicesDetails({required PatientBillModule patientBillData}) {
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          Container(
            padding: const EdgeInsets.only(top: 8, bottom: 10, right: 8),
          ...
          if (patientBillData.billItems.validate().isNotEmpty)
            ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                int total =
                    data.price.validate().toInt() * data.qty.validate().toInt();
                return Padding(
                  ...
                  child: Row(children: [
                    ...
                    Text(data.qty.validate(),
                        style: primaryTextStyle(size: 12),
                        textAlign: TextAlign.center),
                    Text('${appStore.currencyPrefix.validate(value: '')}$total${appStore.currencyPostfix.validate(value: '')}',
                            style: primaryTextStyle(size: 12),
                            textAlign: TextAlign.end)
                        .expand(flex: 1),
                  ]),
              ...
              separatorBuilder: (context, index) {
                return const Divider(color: viewLineColor);
              },
            )
          else
            NoDataWidget(
                titleTextStyle: secondaryTextStyle(color: Colors.red),
                title: locale.lblNoRecordsFound),
        ],
      ),
    );
  }
