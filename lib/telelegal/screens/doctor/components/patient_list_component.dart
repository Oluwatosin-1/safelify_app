...
import 'package:safelify/telelegal/screens/encounter/screen/patient_encounter_list_screen.dart';
            ...
            Row(
              ...
              children: [
                ImageBorder(
                  ...
                  height: 40,
                  nameInitial: widget.patientData!.displayName
                      .validate()
                      .split('')
                      .first,
                ),
            ...
            Positioned(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (isVisible(
                      SharedPreferenceKey.kiviCarePatientEncounterListKey))
