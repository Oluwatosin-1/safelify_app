...
import 'package:safelify/telelegal/screens/doctor/components/dashboard_count_widget.dart';
    ...
    List<Widget> child = [
      if ((isDoctor() &&
              isVisible(SharedPreferenceKey
                  .kiviCareDashboardTotalTodayAppointmentKey)) ||
          (isReceptionist() &&
              isVisible(SharedPreferenceKey.kiviCareDashboardTotalDoctorKey)))
