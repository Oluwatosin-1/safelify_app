...
import 'package:safelify/telelegal/components/common_row_widget.dart';
...
class AppointmentQuickView extends StatelessWidget {
  ...
  num getTotal() {
    ...
    if (upcomingAppointment.taxData != null &&
        upcomingAppointment.taxData!.taxList.validate().isNotEmpty)
      total = (upcomingAppointment.taxData!.taxList
              .validate()
              .sumByDouble((e) => e.charges.validate()) +
          upcomingAppointment.allServiceCharges.validate());
    else
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Text(locale.lblService.capitalizeFirstLetter(),
                              style: boldTextStyle(size: 14))
                          .expand(),
                      16.width,
                      Text(locale.lblCharges.capitalizeFirstLetter(),
                          style: boldTextStyle(size: 14)),
                    ],
                  ),
                  10.height,
                  ...
                  if (upcomingAppointment.taxData != null &&
                      upcomingAppointment.taxData!.taxList
                          .validate()
                          .isNotEmpty)
                    Row(
                      children: [
                  ...
                  if (upcomingAppointment.taxData != null &&
                    ...
                    Row(
                      children: [
                        Text(locale.lblTax, style: boldTextStyle(size: 12))
                            .expand(),
                        16.width,
                        Text(
                          locale.lblTaxRate,
              ...
              children: List.generate(
                ...
                (index) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      if (isVisible(
                          SharedPreferenceKey.kiviCarePatientReportViewKey))
