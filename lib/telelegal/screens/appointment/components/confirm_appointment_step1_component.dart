...
class ConfirmAppointmentStep1Component extends StatefulWidget {
  ...
  ConfirmAppointmentStep1Component(
      {this.changeIndexCallback, this.isUpdate = false});

  @override
  State<ConfirmAppointmentStep1Component> createState() =>
      _ConfirmAppointmentStep1ComponentState();
}

class _ConfirmAppointmentStep1ComponentState
    extends State<ConfirmAppointmentStep1Component> {
  int? selectedIndex;
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        42.height,
        Text(
            "${isDoctor() ? 'Lawyer.  ${userStore.firstName}' : '${userStore.firstName}'}, ${locale.lblAppointmentConfirmation}.",
        ...
        Row(
          ...
          children: [
            Text(appointmentAppStore.mSelectedTime.validate(),
                    style: boldTextStyle(size: 18), textAlign: TextAlign.end)
                .expand(flex: 3),
            ...
            if (isDoctor() || isReceptionist())
              ...
              Text(
                "${appointmentAppStore.mDoctorSelected?.displayName.validate().split(' ').first.capitalizeEachWord().prefixText(value: 'Lawyer.  ')}",
        ...
        RoleWidget(
          ...
          child: RichTextWidget(
            list: [
              TextSpan(
                  text: "Firm", style: secondaryTextStyle(size: 16)),
        ...
        if (appointmentAppStore.mDescription.validate().isNotEmpty)
          RoleWidget(
            ...
            child: RichTextWidget(
              ...
              list: [
                TextSpan(
                    text: '${locale.lblDesc} : ', style: primaryTextStyle()),
                TextSpan(
          ...
          RichTextWidget(
            ...
            list: [
              TextSpan(
                  ...
                  style: primaryTextStyle()),
              TextSpan(
                  text: appointmentAppStore.mSelectedPaymentMethod,
                  style: primaryTextStyle()),
            ],
          ),
        RoleWidget(
          isShowPatient:
              isPatient() && paymentMethodList.isNotEmpty && !widget.isUpdate,
          child: Column(
              ...
              Container(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<int>(
                    value: selectedIndex,
                    icon: ic_arrow_down.iconImage(
                        size: 18, color: context.iconColor),
                    dropdownColor: context.cardColor,
                    hint: Text(locale.lblSelectPaymentMethod,
                      ...
                      (index) {
                        return DropdownMenuItem<int>(
                          ...
                          child: TextIcon(
                            ...
                            prefix:
                                paymentMethodImages[index].iconImageColored(),
                          ),
                        );
                      },
                    ),
                    onChanged: (value) {
                      ...
                      appointmentAppStore
                          .setPaymentMethod(paymentModeList[selectedIndex!]);
                    },
                  ),
                ),
              ),
        ...
        if ((isPatient() && paymentMethodList.isNotEmpty) || widget.isUpdate)
          20.height,
        Observer(
          builder: (_) => AppButton(
              width: context.width(),
              ...
              onTap: () {
                if (isPatient() && !widget.isUpdate) {
                  if (paymentMethodList.isNotEmpty && selectedIndex != null) {
                    widget.changeIndexCallback
                        ?.call(paymentModeList[selectedIndex!]);
                  } else {
