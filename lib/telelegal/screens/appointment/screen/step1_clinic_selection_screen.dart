...
import 'package:safelify/telelegal/network/clinic_repository.dart';
...
class Step1ClinicSelectionScreen extends StatefulWidget {
  ...
  const Step1ClinicSelectionScreen({
    Key? key,
    this.sessionOrEncounter = false,
    this.clinicId,
  });
...
class _Step1ClinicSelectionScreenState extends State<Step1ClinicSelectionScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget(
        widget.sessionOrEncounter ? 'Select Firm' : locale.lblAddNewAppointment,
                ...
                return AnimatedListView(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return GestureDetector(
                      onTap: () {
                        if (widget.sessionOrEncounter) {
                          ...
                          if (appointmentAppStore.mClinicSelected != null &&
                              appointmentAppStore.mClinicSelected!.id.validate() == data.id.validate()) {
                            appointmentAppStore.setSelectedClinic(null);
                          } else {
                            appointmentAppStore.setSelectedClinic(data);
                          }
                      ...
                      child: Observer(
                        builder: (context) {
                          bool isSelected = appointmentAppStore.mClinicSelected != null &&
                              appointmentAppStore.mClinicSelected!.id.validate() == data.id.validate();
        ...
        children: [
          Positioned(
            ...
            child: FloatingActionButton(
              heroTag: 'whatsapp_button_telelegal_step1',
          ...
          Positioned(
            ...
            child: FloatingActionButton.extended(
              heroTag: 'proceed_button_telelegal_step1',
              label: Text(widget.sessionOrEncounter ? 'Done' : 'Proceed'),
