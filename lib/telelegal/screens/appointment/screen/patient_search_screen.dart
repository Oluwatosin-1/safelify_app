...
import 'package:safelify/telelegal/screens/shimmer/screen/patient_search_shimmer_screen.dart';
...
class _PatientSearchScreenState extends State<PatientSearchScreen> {
  ...
  Future<void> init({bool showLoader = true}) async {
    ...
    future = getPatientListAPI(
      ...
      doctorId: isDoctor()
          ? userStore.userId
          : appointmentAppStore.mDoctorSelected!.iD.validate(),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget('Client List',
        ...
        return Stack(
          ...
          children: [
            ...
            SnapHelperWidget<List<UserModel>>(
              future: future,
              loadingWidget: const PatientSearchShimmerScreen(),
              errorBuilder: (error) {
                return NoDataWidget(
