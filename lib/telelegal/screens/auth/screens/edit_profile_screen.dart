...
import 'package:safelify/telelegal/screens/auth/components/qualification_widget.dart';
import 'package:safelify/telelegal/screens/auth/screens/map_screen.dart';
import 'package:safelify/telelegal/screens/receptionist/components/multi_select_specialization.dart';
    ...
    if (isDoctor()) {
      ...
      if (userData.specialties.validate().isNotEmpty) {
        ...
        specializationList.validate().forEach((element) {
          multiSelectStore1.addSingleStaticItem(element, isClear: false);
                                    ...
                                    children: [
                                      ...
                                      Wrap(
                                        ...
                                        children: List.generate(
                                          ...
                                          (index) {
                                            StaticData data = multiSelectStore1
