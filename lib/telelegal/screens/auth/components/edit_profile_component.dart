...
import 'package:safelify/telelegal/screens/auth/screens/edit_profile_screen.dart';
import 'package:safelify/telelegal/screens/dashboard/screens/common_settings_screen.dart';
...
class EditProfileComponent extends StatelessWidget {
  ...
  bool get showClinic {
    if (isReceptionist() || isPatient())
      return isVisible(SharedPreferenceKey.kiviCarePatientClinicKey) &&
        ...
        Row(
          ...
          children: [
                ...
                if (userStore.profileImage.validate().isNotEmpty)
                  GradientBorder(
                      ...
                      gradient: LinearGradient(
                          colors: [viewLineColor, viewLineColor]),
            ...
            ic_settings
                ...
                .paddingAll(14)
                .appOnTap(() {
              CommonSettingsScreen().launch(context,
                  ...
                  Row(
                    children: [
                      ...
                      Text(userStore.userClinic!.name.validate(),
                          ...
                          .expand(),
                      if (userStore.userClinic!.status.validate().isNotEmpty)
                        StatusWidget(
