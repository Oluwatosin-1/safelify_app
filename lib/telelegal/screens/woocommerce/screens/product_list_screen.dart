...
import 'package:safelify/telelegal/screens/woocommerce/component/sort_filter_bottom_sheet_component.dart';
...
class ProductListScreen extends StatefulWidget {
  ...
  const ProductListScreen(
      {this.categoryId, this.refreshCall, this.categoryName});
...
class _ProductListScreenState extends State<ProductListScreen> {
  ...
  Future<void> selectedFilterSort(
      {bool isOrderBy = false, FilterModel? filterValue}) async {
    setState(() {
      ...
      appBar: appBarWidget(
        ...
        actions: [
          ic_checkList
              ...
              .appOnTap(() {
            OrderListScreen(isFromProduct: true).launch(context,
                    ...
                    defaultWidget: SingleChildScrollView(
                      child: NoDataFoundWidget(
                        text: searchCont.text.isEmpty
                            ? locale.lblNoProductsFound
                            : locale.lblCantFindProductYouSearchedFor,
                        onRetry: () {
