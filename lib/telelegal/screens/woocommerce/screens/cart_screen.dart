...
import 'package:safelify/telelegal/screens/shimmer/screen/cart_shimmer_screen.dart';
import 'package:safelify/telelegal/screens/woocommerce/component/coupon_component.dart';
import 'package:safelify/telelegal/screens/woocommerce/screens/checkout_screen.dart';
import 'package:safelify/telelegal/screens/woocommerce/screens/coupon_list_screen.dart';
...
class _CartScreenState extends State<CartScreen> {
  ...
  setTotal() {
    subTotal = cartItemList.map((e) => e).toList().sumByDouble((p) =>
        (double.parse(getPrice(p.prices!.price.validate())) *
            p.quantity.validate().toInt()));

    total = subTotal;
    if (cart!.totals != null &&
        cart!.totals!.totalDiscount.validate().isNotEmpty) {
              ...
              onSuccess: (data) {
                ...
                return AnimatedScrollView(
                  ...
                  children: [
                              ...
                              Row(
                                ...
                                children: [
                                  CachedImageWidget(
                                    ...
                                    () {
                                      ProductDetailScreen(
                                              productId: cartItem.id.validate())
                                          .launch(context);
                                    },
                                  ),
                                  16.width,
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      PriceWidget(
                                        price: getPrice(
                                            cartItem.prices!.price.validate()),
                                        ...
                                        postFix:
                                            cartItem.prices!.currencySuffix,
                                      ).appOnTap(
                                        () {
                                          ProductDetailScreen(
                                                  productId:
                                                      cartItem.id.validate())
                                              .launch(context);
                                        },
                                      ),
                                      8.height,
                    ...
                    Align(
                      child: Text(locale.lblViewCoupons,
                              style: primaryTextStyle(color: appSecondaryColor))
                          .paddingSymmetric(horizontal: 16)
                          .appOnTap(() {
                        CouponListScreen(
                          isCartScreen: true,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              8.height,
                              if (double.parse(cart!.totals!.totalDiscount
                                          .validate())
                                      .toInt() >
                                  0)
                                Row(
                              ...
                              8.height,
                              if (double.parse(cart!.totals!.totalShipping
                                          .validate())
                                      .toInt() >
                                  0)
                                Row(
                                  children: [
                                    Text(locale.lblShippingCost,
                                        ...
                                        .expand(),
                                    PriceWidget(
                                      price: cart!.totals!.totalShipping
                                          .validate(),
                                      size: 16,
                                      textAlign: TextAlign.start,
                                    ),
                  ...
                  onTap: () async {
                    if (!appStore.isLoading)
                      await Future.forEach<CartItemModel>(
                          cart!.items.validate(), (element) async {
                        if (element.isQuantityChanged.validate()) {
                          appStore.setLoading(true);
                          try {
                            await updateCartItem(
