...
import 'package:safelify/telelegal/components/disabled_rating_bar_widget.dart';
...
import 'package:safelify/telelegal/screens/patient/screens/web_view_payment_screen.dart';
import 'package:safelify/telelegal/screens/shimmer/components/shimmer_component.dart';
import 'package:safelify/telelegal/screens/shimmer/screen/product_detail_shimmer_screen.dart';
import 'package:safelify/telelegal/screens/woocommerce/component/product_component.dart';
import 'package:safelify/telelegal/screens/woocommerce/component/product_review_component.dart';
...
import 'package:safelify/telelegal/screens/woocommerce/screens/wish_list_screen.dart';
...
class ProductDetailScreen extends StatefulWidget {
  ...
  const ProductDetailScreen(
      {Key? key, required this.productId, this.refreshCall})
      : super(key: key);
...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
  ...
  void init({bool showLoader = false}) async {
    ...
    future =
        getProductDetail(productId: widget.productId.validate()).then((value) {
      productData = value;
      isFetched = true;
      ...
      if (value.type == ProductTypes.grouped) {
        ...
        value.groupedProducts.validate().forEach((e) {
          groupProductList
              .add(GroupProductModel(id: e.id.validate(), product: e));
  ...
  void removeFromFav() {
    ...
    removeFromWishlist(productId: productData.id.validate()).then((value) {
  ...
  void addToFavorite() {
    ...
    addToWishlist(productId: productData.id.validate()).then((value) {
      widget.refreshCall?.call();
      toast(value.message);
    }).catchError((e) {
      isWishListed = false;
      ...
      if (productData.isAddedCart.validate()) {
        ...
        if (productData.stockStatus == 'instock') {
          if (productData.type == ProductTypes.external) {
            ...
            appStore.setLoading(true);
            addItemToCart(productId: productData.id.validate(), quantity: count)
                .then((value) {
        ...
        headerSliverBuilder: ((BuildContext context, bool innerBoxIsScrolled) {
          return <Widget>[
            SliverAppBar(
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        left: isRTL ? 16 : null,
                        right: isRTL ? null : 16,
                        child: ic_wishList_cart
                            .iconImageColored(color: appSecondaryColor)
                            .appOnTap(() {
                          WishListScreen(isFromProductDetail: true).launch(
                              context,
                              pageRouteAnimation: pageAnimation,
                              duration: pageAnimationDuration);
                        }),
              ...
              title: Text(productData.name.validate().capitalizeFirstLetter(),
              ...
              actions: [
                Stack(
                  children: [
                    ic_cart
                        .iconImageColored(
                            size: 22, color: shimmerPrimaryBaseColor)
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Text(
                            shopStore.itemsInCartCount.validate().toString(),
                    ...
                    children: [
                      Container(
                        ...
                        child: Container(
                          ...
                          child: Text(locale.lblSale,
                              style: secondaryTextStyle(
                                  size: 10, color: Colors.white)),
                        ),
                      ).visible(productData.onSale.validate()),
                      Text(productData.name.validate().capitalizeFirstLetter(),
                      ...
                      Row(
                        ...
                        children: [
                          DisabledRatingBarWidget(
                            rating:
                                productData.averageRating.validate().toDouble(),
                            size: 18,
                          ),
                          16.width,
                          Text(
                              '(${productData.ratingCount} ${locale.lblReview})',
                              style: secondaryTextStyle(
                          ...
                          productData.averageRating.validate().toDouble() !=
                              0.0),
                      16.height,
                      if (productData.type.validate() != ProductTypes.grouped &&
                          productData.type.validate() != ProductTypes.variable)
                        Row(
                          children: [
                      ...
                      if (productData.categories.validate().isNotEmpty)
                        Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(locale.lblCategory.suffixText(value: ' : '),
                                style: boldTextStyle(size: 14)),
                            Wrap(
                      ...
                      if ((groupProductList.validate().isNotEmpty &&
                              productData.type == ProductTypes.grouped) ||
                          (groupProductList.validate().isNotEmpty &&
                              productData.type == ProductTypes.variable))
                        16.height,
                      if ((groupProductList.validate().isNotEmpty &&
                              productData.type == ProductTypes.grouped) ||
                          (groupProductList.validate().isNotEmpty &&
                              productData.type == ProductTypes.variable))
                        Text(locale.lblChooseFromCollection,
                                style: primaryTextStyle())
                            .paddingSymmetric(horizontal: 16),
                      if ((groupProductList.validate().isNotEmpty &&
                              productData.type == ProductTypes.grouped) ||
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Icon(
                                    ...
                                    ProductDetailScreen(productId: e.id)
                                        .launch(context);
                                  })
                                ],
                              )
                      ...
                      if (!getBoolAsync(AppKeys.hasInReviewKey) &&
                          productData.description.validate().isNotEmpty)
                        16.height,
                      if (!getBoolAsync(AppKeys.hasInReviewKey) &&
                          productData.description.validate().isNotEmpty)
                        Text(locale.lblDescription, style: boldTextStyle())
                            .paddingSymmetric(horizontal: 16),
                      if (!getBoolAsync(AppKeys.hasInReviewKey) &&
                          productData.description.validate().isNotEmpty)
                        8.height,
                      ...
                      if (productData.attributes.validate().isNotEmpty)
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(locale.additionalInformation,
                                    style: boldTextStyle())
                                .paddingSymmetric(horizontal: 16),
                            Table(
                              columnWidths: {
                              ...
                              children:
                                  productData.attributes.validate().map((e) {
                                return TableRow(
                                  decoration: boxDecorationDefault(
                                      color: context.cardColor),
                                  children: [
                      ...
                      if (productData.relatedProductList.validate().isNotEmpty)
                        Column(
                          ...
                          children: [
                            16.height,
                            Text(locale.relatedProducts,
                                    style: boldTextStyle(size: 18))
                                .paddingSymmetric(horizontal: 18),
                            HorizontalList(
                              padding: EdgeInsets.all(16),
                              spacing: 16,
                              itemCount: productData.relatedProductList
                                  .validate()
                                  .length,
                              itemBuilder: (ctx, index) {
                                return RelatedProductCardComponent(
                                    product: productData.relatedProductList
                                        .validate()[index]);
                              },
                            ),
                          ],
          ...
          ? Container(
              ...
              child: Row(
                ...
                children: [
                  isWishListed
                      ? ic_wish_listed
                          .iconImageColored(size: 24, color: Colors.red)
                          .appOnTap(removeFromFav)
                          .paddingLeft(16)
                          .paddingRight(16)
                      : ic_favList
                          .iconImageColored(size: 24, color: context.iconColor)
                          .appOnTap(addToFavorite)
                          .paddingLeft(16)
                          .paddingRight(16),
                  AppButton(
                    shapeBorder:
                    ...
                    color: productData.isAddedCart.validate()
                      ...
                      isFetched && productData.type != ProductTypes.grouped),
                ],
