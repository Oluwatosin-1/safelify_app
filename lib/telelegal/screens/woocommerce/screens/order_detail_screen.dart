...
import 'package:safelify/telelegal/screens/shimmer/screen/order_detail_shimmer_screen.dart';
import 'package:safelify/telelegal/screens/woocommerce/component/cancel_order_form_component.dart';
import 'package:safelify/telelegal/screens/woocommerce/component/order_status_component.dart';
import 'package:safelify/telelegal/screens/woocommerce/screens/product_detail_screen.dart';
...
class OrderDetailScreen extends StatefulWidget {
  ...
  const OrderDetailScreen(
      {required this.orderDetails, required this.orderId, this.callback});
...
class _OrderDetailScreenState extends State<OrderDetailScreen> {
  ...
  void init({bool showLoader = false}) async {
    ...
    future = getOrder(orderId: widget.orderId.validate()).then((value) {
      orderDetails = value;
      isSameAddress = orderDetails.shipping!.postcode.validate() ==
              orderDetails.billing!.postcode.validate() &&
          orderDetails.shipping!.firstName.validate() ==
              orderDetails.billing!.firstName.validate();
        ...
        return CancelOrderFormComponent(
          ...
          callback: (text) {
            showConfirmDialogCustom(
              ...
              onAccept: (c) {
                appStore.setLoading(true);
                cancelOrder(orderId: widget.orderId.validate(), note: text)
                    .then((value) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          SnapHelperWidget(
            ...
            onSuccess: (orderData) {
              return SingleChildScrollView(
                padding:
                    EdgeInsets.only(left: 16, right: 16, bottom: 70, top: 16),
                child: Column(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        OrderStatusComponent(
                            status: orderDetails.status.validate()),
                      ],
                    ),
                    16.height,
                    Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('#${orderDetails.id.validate().toString()}',
                          ...
                          Row(
                            children: [
                              Text('${locale.lblPaymentMethod}:',
                                  style: primaryTextStyle()),
                              8.width,
                              Text(orderDetails.paymentMethodTitle.validate(),
                                      style: primaryTextStyle(),
                                      maxLines: 1,
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          10.height,
                          if (double.parse(
                                      orderDetails.discountTotal.validate())
                                  .toInt() >
                              0)
                            Divider(height: 16),
                                      ...
                                      (e) => Row(
                                        children: [
                                          Text(
                                              ...
                                              style: secondaryTextStyle()),
                                          4.width,
                                          Text(e.code.validate(),
                                              style: secondaryTextStyle()),
                                          24.width,
                                          PriceWidget(
                                                  price: e.discount.validate(),
                                                  textStyle:
                                                      secondaryTextStyle())
                                              .expand(),
                                        ],
                              ...
                              children: [
                                ...
                                Wrap(
                                  children: [
                                    Text(' - ',
                                        style: secondaryTextStyle(
                                            color: ratingBarLightGreenColor)),
                                    PriceWidget(
                                      price:
                                          orderDetails.discountTotal.validate(),
                                      textStyle: secondaryTextStyle(
                          ...
                          2.height,
                          if (orderDetails.taxLines != null &&
                              orderDetails.taxLines.validate().isNotEmpty)
                            Column(
                              children: [
                                Row(
                                  children: [
                                ...
                                ...orderDetails.taxLines
                                  ...
                                  return Row(
                                    ...
                                    children: [
                                      Text(data.taxName.validate(),
                                              maxLines: 1,
                                              overflow: TextOverflow.ellipsis,
                                              style:
                                                  secondaryTextStyle(size: 14))
                                          .expand(),
                                      Text(data.slug.validate(),
                                              maxLines: 1,
                                              overflow: TextOverflow.ellipsis,
                                              style:
                                                  secondaryTextStyle(size: 14))
                                      ...
                                      PriceWidget(
                                        price:
                                            double.parse(data.rate.validate())
                                                .toStringAsFixed(2),
                                        textStyle: secondaryTextStyle(),
                                        textAlign: TextAlign.center,
                          ...
                          if (double.parse(orderDetails.totalTax.validate())
                                  .toInt() >
                              0)
                            Row(
                              children: [
                                ...
                                PriceWidget(
                                  price: getPrice(
                                      orderDetails.totalTax.validate()),
                                  textStyle: secondaryTextStyle(),
                                ),
                              ],
                            ),
                          if (double.parse(
                                      orderDetails.shippingTotal.validate())
                                  .toInt() >
                              0)
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text(
                                  locale.lblShippingCost
                                      .suffixText(value: ' - '),
                                  style: secondaryTextStyle(),
                                ),
                                Wrap(
                                  children: orderDetails.shippingLines
                                      .validate()
                                      .map((e) {
                                    return PriceWidget(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                    orderDetails.billing!.firstName.validate() +
                                        ' ${orderDetails.billing!.lastName.validate()}',
                                    style: primaryTextStyle()),
                              ],
                            ),
                            8.height,
                            ...
                            Row(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('${locale.lblAddress} - ',
                                    style: primaryTextStyle()),
                                8.width,
                                Text('${orderDetails.billing!.address_1.validate().toString()}, ${orderDetails.billing!.address_2.validate().toString()}',
                                        style: primaryTextStyle())
                                    .expand(),
                              ],
                            ),
                            ...
                            ).visible(orderDetails.billing!.state
                                .validate()
                                .isNotEmpty),
                            8.height,
                            Row(
                            ...
                            Row(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('${locale.lblPostalCode} - ',
                                    style: primaryTextStyle()),
                                8.width,
                                Text(orderDetails.billing!.postcode.validate(),
                                        style: primaryTextStyle())
                                    .expand(),
                              ],
                            ).visible(orderDetails.billing!.postcode
                                .validate()
                                .isNotEmpty),
                            8.height,
                            Row(
                            ...
                            ).visible(orderDetails.billing!.phone
                                .validate()
                                .isNotEmpty),
                          ],
                        ),
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                  orderDetails.shipping!.firstName.validate() +
                                      ' ${orderDetails.shipping!.lastName.validate()}',
                                  style: primaryTextStyle()),
                            ],
                          ),
                          8.height,
                          Row(
                            ...
                            children: [
                              Text('Company - ', style: primaryTextStyle()),
                              8.width,
                              Text(orderDetails.shipping!.company.validate(),
                                  style: primaryTextStyle()),
                            ],
                          ).visible(orderDetails.shipping!.company
                              .validate()
                              .isNotEmpty),
                          8.height,
                          Row(
                            ...
                            children: [
                              Text('${locale.lblAddress} - ',
                                  style: primaryTextStyle()),
                              8.width,
                              Text('${orderDetails.shipping!.address_1.validate()} ${orderDetails.billing!.address_2.validate().prefixText(value: ',')}',
                                      style: primaryTextStyle())
                                  .expand(),
                            ],
                          ).visible(orderDetails.shipping!.address_1
                                  .validate()
                                  .isNotEmpty ||
                          ...
                          ).visible(orderDetails.shipping!.city
                              .validate()
                              .isNotEmpty),
                          8.height,
                          Row(
                            ...
                            children: [
                              Text('${locale.state} - ',
                                  style: primaryTextStyle()),
                              8.width,
                              Text(orderDetails.shipping!.state.validate(),
                                  style: primaryTextStyle()),
                            ],
                          ).visible(orderDetails.shipping!.state
                              .validate()
                              .isNotEmpty),
                          8.height,
                          Row(
                            ...
                            children: [
                              Text('${locale.lblCountry} - ',
                                  style: primaryTextStyle()),
                              8.width,
                              Text(orderDetails.shipping!.country.validate(),
                                  style: primaryTextStyle()),
                            ],
                          ).visible(orderDetails.shipping!.country
                              .validate()
                              .isNotEmpty),
                          8.height,
                          Row(
                            ...
                            children: [
                              Text('${locale.lblPostalCode} - ',
                                  style: primaryTextStyle()),
                              8.width,
                              Text(orderDetails.shipping!.postcode.validate(),
                                  style: primaryTextStyle()),
                            ],
                          ).visible(orderDetails.shipping!.postcode
                              .validate()
                              .isNotEmpty),
                          8.height,
                          Row(
                            ...
                            children: [
                              Text('${locale.lblContactNumber} - ',
                                  style: primaryTextStyle()),
                              8.width,
                              Text(orderDetails.shipping!.phone.validate(),
                                      style: primaryTextStyle())
                                  .expand(),
                            ],
                          ).visible(orderDetails.shipping!.phone
                              .validate()
                              .isNotEmpty),
                        ],
                      ),
          ...
          Observer(
              builder: (ctx) => LoaderWidget().visible(appStore.isLoading)),
        ],
      ),
    );
  }
