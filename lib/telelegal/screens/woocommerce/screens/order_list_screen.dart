...
import 'package:safelify/telelegal/screens/shimmer/screen/order_list_shimmer_screen.dart';
import 'package:safelify/telelegal/screens/woocommerce/component/order_component.dart';
              ...
              SnapHelperWidget(
                ...
                onSuccess: (List<OrderModel> data) {
                  if (dropDownValue != null &&
                      dropDownValue!.value.validate().isNotEmpty) {
