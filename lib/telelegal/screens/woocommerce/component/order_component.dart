...
class OrderComponent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    double subTotal = orderData.lineItems
        .validate()
        .map((e) => e)
        .toList()
        .sumByDouble((p) => double.parse(p.subtotal.validate()));
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text('#${orderData.id}',
                  style: secondaryTextStyle(color: appPrimaryColor)),
          ...
          ListView.builder(
            ...
            itemBuilder: (ctx, i) {
              ...
              return Row(
                ...
                children: [
                  CachedImageWidget(
                    url: orderItem.image!.src.validate().isNotEmpty
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                          '${orderItem.name.validate()} * ${orderItem.quantity.validate()}',
          ...
          Row(
            children: [
              Text('${locale.lblSubTotal} - ', style: secondaryTextStyle())
                  .expand(),
              PriceWidget(
                textStyle: secondaryTextStyle(),
                ...
                Wrap(
                  children: [
                    ...
                    PriceWidget(
                      ...
                      textStyle:
                          secondaryTextStyle(color: ratingBarLightGreenColor),
                    )
                  ],
                ),
              ],
          ...
          if (double.parse(orderData.totalTax.validate()).toInt() > 0)
            Row(
              children: [
                Text('${locale.lblTotalTax} - ', style: secondaryTextStyle())
                    .expand(),
                PriceWidget(
                  textStyle: secondaryTextStyle(),
                  price: getPrice(orderData.totalTax.validate())
                      .toDouble()
                      .toStringAsFixed(2),
                ),
              ],
          ...
          if (double.parse(orderData.shippingTotal.validate()).toInt() > 0)
            Row(
              children: [
                Text(locale.lblShippingCost, style: secondaryTextStyle())
                    .expand(),
                PriceWidget(
                  textStyle: secondaryTextStyle(),
