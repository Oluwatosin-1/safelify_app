...
import 'package:safelify/telelegal/utils/extensions/double_extension.dart';
            ...
            onSuccess: (snap) {
              if (snap.isNotEmpty) {
                return Column(
                  ...
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Text(locale.reviews.capitalizeFirstLetter(),
                        style: boldTextStyle()),
                    24.height,
                    ListView.builder(
                        ...
                        return Stack(
                          children: [
                            Row(
                              ...
                              children: [
                                ImageBorder(
                                  src: review.reviewerAvatarUrls!.full
                                      .validate(),
                                  height: 40,
                                  width: 40,
                                ),
                                ...
                                Column(
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        Text(
                                          review.reviewer.validate().isEmpty
                                              ? review.reviewerEmail.validate()
                                        ...
                                        Text(
                                            convertToAgo(review.dateCreatedGmt
                                                .validate()),
                                            style:
          ...
          Form(
            ...
            child: AppTextField(
              ...
              decoration: inputDecoration(
                  context: context, hintText: locale.lblReviewHint),
...
class UpdateReviewComponent extends StatefulWidget {
  ...
  const UpdateReviewComponent(
      {this.review, this.rating, this.reviewId, this.callback});
