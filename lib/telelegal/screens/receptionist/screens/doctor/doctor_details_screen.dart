...
import 'package:safelify/telelegal/components/ul_widget.dart';
...
import 'package:safelify/telelegal/screens/patient/screens/review/component/review_widget.dart';
import 'package:safelify/telelegal/screens/patient/screens/review/rating_view_all_screen.dart';
import 'package:safelify/telelegal/screens/receptionist/components/qualification_item_widget.dart';
import 'package:safelify/telelegal/screens/receptionist/screens/doctor/add_doctor_screen.dart';
...
class DoctorDetailScreen extends StatefulWidget {
  ...
  DoctorDetailScreen({Key? key, this.refreshCall, required this.doctorData})
      : super(key: key);
                            ...
                            children: [
                              Container(
                                ...
                                decoration: boxDecorationDefault(
                                  ...
                                  color:
                                      doctor.profileImage.validate().isNotEmpty
                                          ? null
                          ...
                          Container(
                            ...
                            child: ULWidget(
                              children: List.generate(
                                ...
                                (index) => Text(
                                    '${doctor.specialties.validate()[index].label.validate()}',
                                    style: primaryTextStyle()),
                              ),
                            ),
                          ),
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Wrap(
                            spacing: 6,
                            children:
                                doctor.qualifications.validate().map((element) {
                          ...
                          child: Row(
                            children: [
                              ...
                              if (doctor.available.validate().isNotEmpty)
                                ...
                                Text("Lawyer.  ${doctor.displayName} ${locale.lblWeekDaysDataNotFound}",
                                        style: primaryTextStyle())
                                    .expand(),
                            ],
                          ),
                      ...
                      AnimatedScrollView(
                        ...
                        children: [
                          ViewAllLabel(
                            ...
                            labelSize: 16,
                            subLabel:
                                '${locale.lblKnowWhatYourPatientsSaysAboutYou} ${doctor.displayName.validate().prefixText(value: 'Lawyer.  ')}',
                            viewAllShowLimit: 5,
