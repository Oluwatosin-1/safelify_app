...
import 'package:safelify/telelegal/components/appointment_fragment_status_compoent.dart';
import 'package:safelify/telelegal/screens/shimmer/screen/appointment_fragment_shimmer.dart';
...
class _RAppointmentFragmentState extends State<RAppointmentFragment> {
  ...
  void initState() {
    ...
    if (res.isNotEmpty) {
      cachedReceptionistAppointment = (jsonDecode(res) as List)
              ...
              onSuccess: (snap) {
                return AnimatedScrollView(
                  ...
                  children: snap.map((upcomingData) {
                    ...
                    defaultWidget: NoDataFoundWidget(text: getEmptyText())
                        .center()
