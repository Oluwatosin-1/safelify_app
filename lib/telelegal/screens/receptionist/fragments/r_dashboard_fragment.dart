...
import 'package:safelify/telelegal/screens/appointment/components/appointment_widget.dart';
import 'package:safelify/telelegal/screens/doctor/components/dashboard_fragment_analytics_component.dart';
import 'package:safelify/telelegal/screens/doctor/components/dashboard_fragment_appointment_component.dart';
import 'package:safelify/telelegal/screens/doctor/fragments/appointment_fragment.dart';
import 'package:safelify/telelegal/screens/shimmer/screen/doctor_dashboard_shimmer_fragment.dart';
...
import 'package:safelify/telelegal/utils/widgets/calender/flutter_clean_calendar.dart';
...
import 'package:safelify/telelegal/utils/widgets/calender/date_utils.dart';
...
class _RDashboardFragmentState extends State<RDashboardFragment> {
  ...
  void initState() {
    super.initState();
    String res =
        getStringAsync(SharedPreferenceKey.cachedDashboardDataKey).validate();
    if (res.isNotEmpty) {
      cachedReceptionistDashboardModel = DashboardModel.fromJson(jsonDecode(
  ...
  void init() async {
    future = getUserDashBoardAPI().then((value) {
      setState(() {});
      getAppointmentApi(
          startDate: startDate, endDate: endDate, showLoader: false);
                      ...
                      children: [
                            ...
                            Row(
                              children: [
                                Text(locale.lblTodaySAppointments,
                                    style:
                                        boldTextStyle(size: fragmentTextSize)),
                                8.width,
                                Marquee(
                                        child: Text(
                          ...
                          child: CleanCalendar(
                            ...
                            onDateSelected: (e) {
                              selectedDate = DateTime.parse(
                                  DateFormat(SAVE_DATE_FORMAT).format(e));
                              setState(() {});
                            },
                        ...
                        AnimatedWrap(
                          ...
                          children: List.generate(
                              groupAppointmentByDates(
                                      appointmentList: data)[selectedDate]
                                  .validate()
                                  .length, (index) {
                            UpcomingAppointmentModel upcomingData =
                                groupAppointmentByDates(
                                        appointmentList: data)[selectedDate]
                                    .validate()[index];
