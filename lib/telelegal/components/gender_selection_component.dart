...
import 'package:safelify/telelegal/model/gender_model.dart';
...
class _GenderSelectionComponentState extends State<GenderSelectionComponent> {
  ...
  void init() {
    ...
    if (isUpdate) {
      selectedGender = genderList.indexWhere((element) =>
          element.value == widget.type.validate().toLowerCase().validate());
      setState(() {});
    }
  }
