...
import 'package:safelify/telelegal/model/order_response_model.dart';
...
class CouponModel {
  ...
  factory CouponModel.fromJson(Map<String, dynamic> json) {
    return CouponModel(
      ...
      usedBy: json['used_by'] != null ? (json['used_by'] as List).map((e) => e.toString()).toList() : null,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.usedBy != null) {
      data['used_by'] = this.usedBy!.map((v) => v).toList();
    }
    return data;
  }
}
