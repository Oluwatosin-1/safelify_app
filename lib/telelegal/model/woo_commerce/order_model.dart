import 'package:safelify/telelegal/model/links.dart';
...
import 'package:safelify/telelegal/model/woo_commerce/shipping_lines.dart';
...
class OrderModel {
  ...
  factory OrderModel.fromJson(Map<String, dynamic> json) {
    return OrderModel(
      ...
      couponLines: json['coupon_lines'] != null ? (json['coupon_lines'] as List).map((e) => CouponModel.fromJson(e)).toList() : null,
      ...
      status: json['status'],
      taxLines: json['tax_class'] != null ? (json['tax_class'] as List).map((i) => TaxData.fromJson(i)).toList() : null,
      total: json['total'],
