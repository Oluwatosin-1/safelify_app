...
List<FilterModel> getOrderStatus() {
  ...
  list.add(FilterModel(
      ...
      title: locale.lblPending,
      statusColor: pendingStatusColor));
  list.add(FilterModel(
      value: OrderStatus.processing,
      title: locale.lblProcessing,
      statusColor: processingStatusColor));
  list.add(FilterModel(
      value: OrderStatus.onHold,
      title: locale.lblOnHold,
      statusColor: onHoldStatusColor));
  list.add(FilterModel(
      value: OrderStatus.completed,
      title: locale.lblCompleted,
      statusColor: completedStatusColor));
  list.add(FilterModel(
      value: OrderStatus.cancelled,
      title: locale.lblCancelled,
      statusColor: cancelledStatusColor));
  list.add(FilterModel(
      value: OrderStatus.refunded,
      title: locale.lblRefunded,
      statusColor: refundedStatusColor));
  list.add(FilterModel(
      value: OrderStatus.failed,
      title: locale.lblFailed,
      statusColor: failedStatusColor));
  list.add(FilterModel(
      value: OrderStatus.trash,
      title: locale.lblTrash,
      statusColor: trashStatusColor));
