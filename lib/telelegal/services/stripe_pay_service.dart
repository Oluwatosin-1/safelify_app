...
import 'package:safelify/telelegal/model/stripe_pay_model.dart';
...
class StripeServices {
  ...
  void stripePay() async {
    ...
    request.bodyFields = {
      'amount':
          '${(appointmentBookingData.orderData!.amount.validate()).toInt()}',
        ...
        if (response.statusCode.isSuccessful()) {
          ...
          SetupPaymentSheetParameters setupPaymentSheetParameters =
            ...
            billingDetails: BillingDetails(
                name: userStore.userDisplayName, email: userStore.userEmail),
          );
