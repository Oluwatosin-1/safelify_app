...
import 'package:safelify/telelegal/model/appoinment_model.dart';
import 'package:safelify/telelegal/model/appointment_slot_model.dart';
...
Future<List<UpcomingAppointmentModel>> getPatientAppointmentList(
  ...
  setValue(
    ...
    jsonEncode(
        res.upcomingAppointmentData.validate().map((e) => e.toJson()).toList()),
    print: true,
  );
...
Future<List<UpcomingAppointmentModel>> getAppointment({
  ...
  value = AppointmentModel.fromJson(
      await (handleResponse(await buildHttpResponse(getEndPoint(
    endPoint: ApiEndPoints.getAppointmentEndPoint,
    params: params,
  )))));
...
Future<List<UpcomingAppointmentModel>> getReceptionistAppointmentList({
  ...
  AppointmentModel res = AppointmentModel.fromJson(
      await handleResponse(await buildHttpResponse(getEndPoint(
    endPoint: ApiEndPoints.getAppointmentEndPoint,
    params: param,
  ))));
