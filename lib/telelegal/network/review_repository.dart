...
Future<BaseResponses> deleteReviewAPI({required int id}) async {
  ...
  return BaseResponses.fromJson(await handleResponse(await buildHttpResponse(
      getEndPoint(endPoint: 'kivicare/api/v1/review/delete', params: param),
...
Future<List<RatingData>> doctorReviewsListAPI(
  ...
  RatingResponse res = RatingResponse.fromJson(await handleResponse(
      await buildHttpResponse(
          getEndPoint(
              endPoint: 'kivicare/api/v1/review/get',
              page: page,
