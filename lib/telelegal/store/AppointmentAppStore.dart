...
import 'package:safelify/telelegal/model/doctor_list_model.dart';
...
abstract class AppointmentAppStoreBase with Store {
  ...
  String? mDescription = "";
  @observable
  String? currentLegalCase;

  @observable
  String? detailOfCaseAndGoal;
  ...
  @action
  void setCurrentLegalCase(String? aSelected) => currentLegalCase = aSelected;

  @action
  void setDetailOfCaseAndGoal(String? aSelected) =>
      detailOfCaseAndGoal = aSelected;
