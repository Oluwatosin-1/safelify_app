  ...
  if (url.validate().isNotEmpty) {
    if (isIOS)
      commonLaunchUrl('tel://' + url!,
              showToast: false, launchMode: LaunchMode.externalApplication)
          .catchError((e) {
...
String formatTime(int timestamp) {
  ...
  return result != locale.justNow.capitalizeFirstLetter()
      ? result + ' ${locale.ago.toLowerCase()}'
      : result;
}
