...
import 'package:safelify/screens/doctor/components/patient_list_component.dart';
import 'package:safelify/screens/receptionist/screens/patient/add_patient_screen.dart';
import 'package:safelify/screens/receptionist/screens/patient/view_patient_screen.dart';
import 'package:safelify/screens/shimmer/screen/patient_fragment_shimmer.dart';
                  ...
                  return AnimatedScrollView(
                    ...
                    children: List.generate(
                      ...
                      (index) => PatientListComponent(
                        ...
                        () async {
                          if (showEdit) {
                            await ViewPatientScreen(userId: snap[index].iD).launch(context, pageRouteAnimation: pageAnimation, duration: pageAnimationDuration).then((value) {
                              if (value ?? false) {
                                init(showLoader: true);
                              }
                            });
