...
import 'package:safelify/model/patient_bill_model.dart';
import 'package:safelify/model/tax_model.dart';
import 'package:safelify/network/bill_repository.dart';
import 'package:safelify/screens/doctor/screens/add_bill_item_screen.dart';
...
class _GenerateBillScreenState extends State<GenerateBillScreen> {
  ...
  void setTotalPayable({String v = '0'}) {
    ...
    if (multiSelectStore.taxData != null) {
      payableCont.text = '${payableText + multiSelectStore.taxData!.totalTax.validate()}';
    } else
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            AppTextField(
                              ...
                              onChanged: (p0) {
                                if (billItemData.sumByDouble((element) => element.price.validate().toDouble() * element.qty.validate().toInt()).toDouble() < double.parse(p0.validate())) {
                                  setState(() {
                                    showValidation = true;
                                  });
                                } else {
