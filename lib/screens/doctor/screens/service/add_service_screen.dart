...
import 'package:safelify/model/service_duration_model.dart';
...
import 'package:safelify/network/service_repository.dart';
import 'package:safelify/screens/doctor/components/multi_select_clinic_drop_down.dart';
import 'package:safelify/screens/doctor/screens/service/edit_service_data_screen.dart';
import 'package:safelify/screens/receptionist/components/multi_select_doctor_drop_down.dart';
...
class _AddServiceScreenState extends State<AddServiceScreen> {
  ...
  void serviceDataForReceptionistIfIsUpdate() {
    if (widget.serviceData!.doctorList != null && widget.serviceData!.doctorList.validate().isNotEmpty) {
      ...
      if (selectedDataList.length > 1) {
        doctorCont.text = '${selectedDataList.length} ${locale.lblDoctorsAvailable}';
      } else {
  ...
  void ifLengthIsGreater() {
    ...
    if (selectedDataList.length == 1) {
      ...
      doctorCont.text = "${selectedDataList.length} ${locale.lblDoctorsSelected}";
    }
  }
                                ...
                                onSubmit: (selectedClinicLocalList) {
                                  if (selectedClinicLocalList.isNotEmpty) {
                                    ...
                                    if (selectedClinicList.length > 1) {
                                      clinicCont.text = '${selectedClinicLocalList.length} ${locale.lblClinicsSelected}';
                                    } else {
                                      if (!isUpdate) {
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    ic_clear.iconImage().paddingAll(4).appOnTap(() {
                                      ...
                                      if (selectedClinicList.length > 1) {
                                        clinicCont.text = '${selectedClinicList.length} ${locale.lblClinicsAvailable}';
                                      } else {
