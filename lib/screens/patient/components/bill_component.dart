...
import 'package:safelify/screens/doctor/screens/bill_details_screen.dart';
import 'package:safelify/screens/encounter/screen/encounter_dashboard_screen.dart';
import 'package:safelify/screens/doctor/screens/generate_bill_screen.dart';
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          if (billData.totalTax != null) PriceWidget(price: (billData.totalAmount.validate()- billData.discount.validate() - billData.actualAmount.validate()).abs().toStringAsFixed
                            (2), textSize: 14).expand(),
