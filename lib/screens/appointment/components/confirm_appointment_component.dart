...
import 'package:safelify/screens/appointment/components/confirm_appointment_step1_component.dart';
import 'package:safelify/screens/appointment/components/success_full_payment_component.dart';
import 'package:safelify/screens/patient/screens/web_view_payment_screen.dart';
import 'package:safelify/services/razor_pay_service.dart';
import 'package:safelify/services/stripe_pay_service.dart';
...
class _ConfirmAppointmentScreenState
  ...
  Future<void> saveAppointment() async {
    ...
    if (multiSelectStore.selectedService.isNotEmpty) {
      multiSelectStore.selectedService.forEachIndexed((element, index) {
  ...
  Future<void> paymentRedirection() async {
    if (appStore.paymentMode == PAYMENT_RAZORPAY) {
      ...
      print("============");
      print(appointmentBookingData!.orderData);
      print("============");
