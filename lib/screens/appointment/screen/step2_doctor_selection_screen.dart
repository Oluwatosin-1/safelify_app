...
class Step2DoctorSelectionScreen extends StatefulWidget {
  ...
  const Step2DoctorSelectionScreen({this.clinicId, this.isForAppointment = false, this.doctorId});
...
class _Step2DoctorSelectionScreenState extends State<Step2DoctorSelectionScreen> {
  ...
  Future<void> _launchWhatsApp() async {
    ...
    const String message = 'Hello, I need assistance with doctor selection.';
        ...
        children: [
          Positioned(
            ...
            child: FloatingActionButton(
              heroTag: 'whatsapp_button_telehealth_step2',
          ...
          Positioned(
            ...
            child: FloatingActionButton.extended(
              heroTag: 'proceed_button_telehealth_step2',
