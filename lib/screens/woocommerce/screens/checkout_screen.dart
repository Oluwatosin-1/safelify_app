...
import 'package:safelify/model/woo_commerce/cart_item_model.dart';
import 'package:safelify/model/woo_commerce/cart_model.dart';
import 'package:safelify/model/woo_commerce/payment_model.dart';
...
import 'package:safelify/screens/woocommerce/screens/order_detail_screen.dart';
          ...
          AnimatedScrollView(
            ...
            children: [
              ...
              if (!isSameAddress || shippingAddress == null)
                Row(
                  ...
                  children: [
                    ...
                    Image.asset(ic_edit, width: 22, height: 22, fit: BoxFit.cover, color: context.primaryColor).onTap(() async {
                      const EditShopDetailsScreen().launch(context).then((value) {
              ...
              SnapHelperWidget(
                ...
                onSuccess: (data) {
                  if (data.isEmpty) {
                    return Text(locale.lblNoPaymentMethods, style: secondaryTextStyle());
                  } else {
                    return Container(
                        ...
                        itemBuilder: (ctx, index) {
                          return Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  Icon(selectedPaymentMethod == data[index] ? Icons.radio_button_checked : Icons.radio_button_off, color: context.primaryColor, size: 20),
                                  8.width,
                                  Text(data[index].title.toString().validate(), style: primaryTextStyle()),
                                ],
                              ),
                              8.height,
                              Container(
                                ...
                                child: Text(data[index].description.validate(), style: secondaryTextStyle(size: 12)),
