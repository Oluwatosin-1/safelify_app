...
import 'package:safelify/screens/shimmer/screen/cart_shimmer_screen.dart';
import 'package:safelify/screens/woocommerce/component/coupon_component.dart';
import 'package:safelify/screens/woocommerce/screens/checkout_screen.dart';
                                        ...
                                        children: [
                                          ...
                                          Icon(
                                            ...
                                            if (cartItem.quantity.validate() > 1) {
                                              ...
                                              appStore.setLoading(true);
                                              updateCartItem(productKey: cartItem.key.validate(), quantity: cartItem.quantity.validate()).whenComplete(() {
                                                init();
                                              }).catchError((e) {
                                                toast(e.toString());
