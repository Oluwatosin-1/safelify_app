...
import 'package:safelify/model/woo_commerce/category_model.dart';
...
import 'package:safelify/screens/shimmer/screen/product_list_shimmer_screen.dart';
import 'package:safelify/screens/woocommerce/component/product_component.dart';
import 'package:safelify/screens/woocommerce/component/sort_filter_bottom_sheet_component.dart';
...
class _ProductListScreenState extends State<ProductListScreen> {
  ...
  void removeFromFav({required int productId, bool isWishListed = true}) {
    setState(() {
      isWishListed = !isWishListed;
    });
    removeFromWishlist(productId: productId).then((value) {
      toast(value.message);
      init();
    }).catchError((e) {
      toast(e.toString());
