...
import 'package:safelify/controllers/app_controller.dart';
...
class MightyBottomNavigation extends StatefulWidget {
  const MightyBottomNavigation({
    required this.tabs,
  ...
  @override
  MightyBottomNavigationState createState() => MightyBottomNavigationState();
}

class MightyBottomNavigationState extends State<MightyBottomNavigation> with TickerProviderStateMixin, RouteAware {
  Image nextIcon = Image.asset('assets/icons/fire.png');
  Image activeIcon = Image.asset('assets/icons/fire.png');
  ...
  void didChangeDependencies() {
    ...
    activeIcon = Image(
      image: widget.tabs[currentSelected].iconData.image,
      color: Colors.white,
    );
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: <Widget>[
        Container(
          height: BAR_HEIGHT,
          decoration: BoxDecoration(color: barBackgroundColor, boxShadow: [BoxShadow(color: shadowColor, offset: const Offset(0, -1), blurRadius: 8)]),
          child: Row(
