...
/// A [MightyFilterField] that contains a [TextField].
///
...
/// {@tool snippet}
///
/// Creates a [MightyFilterField] with an [InputDecoration] and validator function.
///
...
///                       onSaved: (String value) {
///                         log('Value for field $index saved as "$value"');
///                       },
///                     ),
///                   ),
///                 );
...
class MightyFilterField extends FormField<String> {
  /// Creates a [MightyFilterField] that contains a [TextField].
  ///
...
class _SelectFormFieldState extends FormFieldState<String> {
  ...
  @override
  MightyFilterField get widget => super.widget as MightyFilterField;
  ...
  @override
  void didUpdateWidget(MightyFilterField oldWidget) {
